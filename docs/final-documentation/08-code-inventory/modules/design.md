...
- Report/document generation details are maintained in the core [Reporting And PDF Architecture](../../01-architecture/reporting-and-pdf-architecture.md) document.
