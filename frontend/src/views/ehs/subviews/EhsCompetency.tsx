    ...
    <div className="space-y-6">
      ...
      <div className="bg-surface-card rounded-2xl border border-border-subtle shadow-sm overflow-hidden">
        <div className="p-6 border-b flex justify-between items-center">
          <h3 className="font-bold text-text-primary">Competency Register</h3>
          <button
            onClick={() => {
              setEditingId(null);
              resetForm();
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-bold ${licenseStatus.color}`}
                      >
                        {licenseStatus.label}
                      </span>
                    </td>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, vehicleMachine: e.target.value })
                  }
                />
              </div>
              <div className="grid grid-cols-2 gap-4">
