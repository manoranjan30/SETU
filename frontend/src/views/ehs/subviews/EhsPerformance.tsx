    ...
    <div className="space-y-6">
      ...
      <div className="bg-surface-card p-6 rounded-2xl border border-border-subtle shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <p className="text-sm text-text-muted mb-1">EHS Rating</p>
            <p className="text-3xl font-black text-text-primary">
              {latest?.ehsRating || "0.00"}
              <span className="text-lg text-text-disabled font-medium">
                /10
              </span>
            </p>
          </div>
          <div>
            <p className="text-sm text-text-muted mb-1">Housekeeping Rating</p>
            <p className="text-3xl font-black text-text-primary">
              {latest?.housekeepingRating || "0.00"}
              <span className="text-lg text-text-disabled font-medium">
                /10
              </span>
            </p>
        ...
        <div className="h-96">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              />
              <Bar
                dataKey="housekeepingRating"
                name="Housekeeping Rating"
                fill="#10b981"
                radius={[4, 4, 0, 0]}
                barSize={20}
              />
      ...
      {showModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-surface-card w-full max-w-md rounded-2xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      ehsRating: Number(e.target.value),
                    })
                  }
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      housekeepingRating: Number(e.target.value),
                    })
                  }
                />
              </div>
