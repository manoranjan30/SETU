...
export default function DashboardBuilderHome() {
  ...
  const [activeTab, setActiveTab] = useState<
    "dashboards" | "assignments" | "templates"
  >("dashboards");
  ...
  return (
    <div style={{ padding: "24px" }}>
      ...
      >
        <button
          ...
          style={{
            ...
            fontSize: 14,
            fontWeight: 700,
            color: activeTab === "dashboards" ? "#2563eb" : "#64748b",
      ...
      {activeTab === "assignments" && (
        <AssignmentManager dashboards={dashboards} />
      )}
      {activeTab === "templates" && (
        ...
        <>
          ...
          {showCreate && (
            ...
            >
              ...
              >
                <h2
                  style={{ margin: "0 0 20px", fontSize: 20, fontWeight: 700 }}
                >
                  Create Dashboard
                </h2>
                ...
                >
                  ...
                  >
                    <span style={{ fontSize: 12, color: "#94a3b8" }}>
                      {db.widgets?.length || 0} widget
                      {(db.widgets?.length || 0) !== 1 ? "s" : ""}
                    </span>
                    <div style={{ display: "flex", gap: 4 }}>
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          navigate(
                            `/dashboard/admin/dashboard-builder/${db.id}/edit`,
                          );
                        }}
                        title="Edit"
                        style={{
