...
export default function ReportDesigner() {
  ...
  const selectedSource = dataSources.find(
    (ds) => ds.key === report.dataSourceKey,
  );
  ...
  return (
    ...
    >
        ...
        <div style={{ display: "flex", gap: 12 }}>
          <button
            ...
            style={{
              ...
              borderRadius: 10,
              background:
                report.name && report.dataSourceKey ? "#2563eb" : "#94a3b8",
              color: "#fff",
              border: "none",
              fontWeight: 700,
              fontSize: 13,
              cursor:
                report.name && report.dataSourceKey ? "pointer" : "default",
            }}
          >
      ...
      <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
        ...
        >
          {(["basic", "columns", "filters", "schedule"] as Step[]).map(
            (s, idx) => (
              <button
                key={s}
          ...
          <div style={{ maxWidth: 720, margin: "0 auto" }}>
            ...
            {step === "columns" && (
              ...
              >
                ...
                <p
                  style={{ margin: "0 0 24px", fontSize: 13, color: "#94a3b8" }}
                >
                  Available fields from <b>{selectedSource?.label}</b>
                </p>
                ...
                >
                  {availableFields.map((f) => {
                    const isSelected = report.columns.some(
                      (c) => c.key === f.key,
                    );
                    return (
                      <button
                  ...
                  >
                    {report.columns.map((c, i) => (
                      ...
                      >
                        ...
                        >
                          {availableFields.find((f) => f.key === c.key)?.type}
                        </span>
                        <button
                          onClick={() =>
                            setReport({
            ...
            {step === "filters" && (
              ...
              >
                ...
                >
                  <Clock size={18} /> Default filters will be automatically
                  applied when the report runs on schedule. Users can still
                  change them during manual runs.
                </p>
                <button
                  style={{
                    marginTop: 24,
                    ...
                    {["NEVER", "DAILY", "WEEKLY", "MONTHLY"].map((f) => (
                      <button
                        ...
                        onClick={() =>
                          setReport({
                            ...report,
                            schedule: { ...report.schedule, frequency: f },
                          })
                        }
                        style={{
                          padding: "12px",
            ...
            >
              ...
              <button
                onClick={() =>
                  step === "basic"
                    ? handleStepNav("columns")
                    : step === "columns"
                      ? handleStepNav("filters")
                      : step === "filters"
