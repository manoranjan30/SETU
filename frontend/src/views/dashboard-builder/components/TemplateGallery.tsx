...
const SYSTEM_TEMPLATES: DashboardTemplate[] = [
  {
    ...
    category: "Executive",
    description:
      "Beautiful multi-widget executive board for all projects: site progress, cash flow, quality rating, and quality progress.",
  ...
  },
  {
    ...
    category: "Operations",
    description:
      "Comprehensive dashboard for project managers covering progress, issues, and budget tracking.",
    isSystemTemplate: true,
  },
  {
    id: -2,
    ...
    category: "Quality",
    description:
      "Track QA/QC approvals, site observations, and defect rates over time.",
    isSystemTemplate: true,
  },
  {
    id: -3,
    ...
    description:
      "Overview of purchase orders, supplier performance, and inventory levels.",
    isSystemTemplate: true,
  },
  {
    id: -4,
    ...
    category: "Management",
    description:
      "Executive view of cashflow, budgets vs actuals, and P&L charts.",
    isSystemTemplate: true,
  },
];
...
export default function TemplateGallery({ onApply }: Props) {
  const [templates, setTemplates] =
    useState<DashboardTemplate[]>(SYSTEM_TEMPLATES);
  ...
  const getIcon = (category: string) => {
    switch (category) {
      ...
      default:
        return <LayoutTemplate size={20} color="#64748b" />;
    }
  };
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <div style={{ padding: "0 0 24px" }}>
        ...
        <p style={{ margin: 0, fontSize: 12, color: "#94a3b8" }}>
          Select a pre-built template to accelerate your dashboard creation
        </p>
      </div>
        ...
        {templates.map((tpl) => (
          <div
            ...
            style={{
              ...
              border: "1px solid",
              borderColor:
                selectedTemplate?.id === tpl.id ? "#2563eb" : "#e2e8f0",
              padding: 24,
              cursor: "pointer",
              transition: "all 0.2s",
              display: "flex",
      ...
      >
        <button
          ...
          style={{
            padding: "12px 32px",
            borderRadius: 8,
            background: selectedTemplate ? "#2563eb" : "#94a3b8",
            color: "#fff",
            border: "none",
            fontWeight: 700,
            fontSize: 14,
