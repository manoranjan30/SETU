...
export default function WidgetConfigPanel({
  ...
  const updateField = (
    section: "queryConfig" | "displayConfig",
    key: string,
    value: any,
  ) => {
    const current = section === "queryConfig" ? queryConfig : displayConfig;
    const setter =
      section === "queryConfig" ? setQueryConfig : setDisplayConfig;
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, overflow: "auto", padding: 20 }}>
        ...
        {["BAR", "LINE", "AREA", "PIE", "DONUT", "SCATTER"].includes(
          widget.widgetType,
        ) && (
          <div style={{ marginBottom: 24 }}>
            <h4
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <select
                ...
                onChange={(e) =>
                  updateField("queryConfig", "labelField", e.target.value)
                }
                style={{
                  width: "100%",
                  padding: "8px 12px",
                ...
                {fields
                  ...
                  .map((f) => (
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={(queryConfig.valueFields || []).includes(
                          f.key,
                        )}
                        onChange={(e) => {
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          >
            <input
              ...
              onChange={(e) =>
                updateField("displayConfig", "showLegend", e.target.checked)
              }
            />
            Show Legend
          </label>
          ...
          >
            <input
              ...
              onChange={(e) =>
                updateField("displayConfig", "showGrid", e.target.checked)
              }
            />
            Show Grid Lines
          </label>
