...
const WIDGET_TYPES = [
    { type: 'KPI', icon: Hash, label: 'KPI Card', desc: 'Single metric with trend' },
        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    padding: '16px 20px', borderBottom: '1px solid #e2e8f0', position: 'sticky',
                ...
                <div style={{ flex: 1, padding: 20 }}>
                    ...
                    {step === 1 && (
                        <>
                            <p style={{ fontSize: 14, fontWeight: 600, color: '#475569', margin: '0 0 16px' }}>
                                Step 1: Choose Widget Type
                            </p>
                                ...
                                {WIDGET_TYPES.map((wt) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div>
                                                <div style={{ fontSize: 13, fontWeight: 600, color: '#1e293b' }}>{wt.label}</div>
                                                <div style={{ fontSize: 11, color: '#94a3b8' }}>{wt.desc}</div>
                                            </div>
                                        </button>
                                    );
                                })}
                        ...
                        <>
                            <button
                                ...
                                style={{
                                    ...
                                    background: '#fff', cursor: 'pointer', color: '#64748b', fontSize: 12,
                                ...
                                {dataSources.map((ds) => (
                                    ...
                                    >
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <span style={{ fontSize: 14, fontWeight: 600, color: '#1e293b' }}>{ds.label}</span>
                                            <span style={{
                                                fontSize: 10, padding: '2px 8px', borderRadius: 12, fontWeight: 600,
                                                background: ds.scope === 'GLOBAL' ? '#dbeafe' : '#f0fdf4',
                        ...
                        <>
                            ...
                            <div style={{
                                ...
                                <div style={{ marginBottom: 8 }}>
                                    <span style={{ fontSize: 12, color: '#64748b' }}>Widget Type: </span>
                                    <span style={{ fontSize: 13, fontWeight: 600, color: '#1e293b' }}>{selectedType}</span>
                                </div>
                                <div>
                                    <span style={{ fontSize: 12, color: '#64748b' }}>Data Source: </span>
