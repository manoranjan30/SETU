...
export function QualityActivityNode({ data }: NodeProps<any>) {
  // Using any broadly or defining specific Node type
  const activityData = data as ActivityNodeData;

  return (
    <div className="bg-surface-card border-2 border-border-default rounded-lg shadow-sm p-3 w-64 hover:border-blue-400 transition-colors">
      <Handle
        type="target"
