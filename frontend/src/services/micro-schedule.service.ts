...
export type MicroScheduleStatus =
  (typeof MicroScheduleStatus)[keyof typeof MicroScheduleStatus];
...
export type MicroActivityStatus =
  (typeof MicroActivityStatus)[keyof typeof MicroActivityStatus];
...
export const microScheduleService = {
  ...
  getMicroSchedulesByProject: async (
    projectId: number,
  ): Promise<MicroSchedule[]> => {
  ...
  getMicroSchedulesByActivity: async (
    activityId: number,
  ): Promise<MicroSchedule[]> => {
  ...
  getActivitiesByMicroSchedule: async (
    microScheduleId: number,
  ): Promise<MicroScheduleActivity[]> => {
  ...
  calculateForecast: async (
    id: number,
  ): Promise<{ forecastFinish: string | null }> => {
    const response = await api.post(
      `/micro-schedules/activities/${id}/calculate-forecast`,
    );
    return response.data;
  },
  ...
  getProductivityStats: async (
    ...
    const response = await api.get(
      `/micro-schedules/activities/${activityId}/productivity`,
    );
    return response.data;
  },
  ...
  getLedgerByActivity: async (
    activityId: number,
  ): Promise<MicroQuantityLedger[]> => {
    const response = await api.get(
      `/micro-schedules/ledger/activity/${activityId}`,
    );
    return response.data;
  },
