...
import { MousePointer2, Square, ZoomIn, ZoomOut, ChevronLeft, ChevronRight, Save, X, Play, Settings, Loader2, Wand2 } from 'lucide-react';
import ZoneOverlay from './ZoneOverlay';
import PropertiesPanel from './PropertiesPanel';
import TestPanel from './TestPanel';
import type { PdfTemplate, TemplateZone, TemplateConfig, ZoneBounds, TemplateField } from '../../types/template.types';
...
const TemplateEditor = ({ template, onSave, onCancel }: TemplateEditorProps) => {
    ...
    const [extractionMode, setExtractionMode] = useState<'all_pages' | 'first_only'>(
    ...
    const handleZoneDrawn = useCallback(async (zone: TemplateZone, bounds: ZoneBounds) => {
        if (!pdfFile) return;
        ...
        try {
            ...
            formData.append('zone_data', JSON.stringify({
                bounds,
            ...
            if (data.success) {
                ...
                const fields: TemplateField[] = (data.detectedFields || []).map((f: DetectedField) => ({
                    key: f.key,
                    label: f.label,
                    type: f.type || 'text',
                    required: false,
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-white border-b border-gray-200 shadow-sm">
                <div className="flex items-center gap-4">
                    ...
                    <input
                        ...
                        className="px-3 py-1.5 text-sm font-medium border border-gray-200 rounded-lg w-48 focus:ring-2 focus:ring-blue-500"
                    />
                    <select
                        value={category}
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex bg-gray-100 rounded-lg p-0.5">
                        <button
                            ...
                            className={`px-3 py-1.5 text-sm rounded-md flex items-center gap-1 transition-colors ${rightPanel === 'properties'
                        ...
                        <button
                            ...
                            className={`px-3 py-1.5 text-sm rounded-md flex items-center gap-1 transition-colors ${rightPanel === 'test'
                                ? 'bg-white shadow text-gray-800'
                                : 'text-gray-500 hover:text-gray-700'
                                }`}
                        >
                    ...
                    <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className={`p-2 rounded-lg transition-colors ${!isDrawing ? 'bg-blue-100 text-blue-600' : 'hover:bg-gray-200'}`}
                            ...
                            {zones.length > 0 && (
                                <div className="flex items-center gap-1 ml-2 px-2 py-1 bg-gray-50 rounded text-xs text-gray-600">
                                    <Wand2 size={12} />
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-gray-600 w-16 text-center font-mono">
                    ...
                    <div className="flex-1 overflow-auto p-4 flex justify-center bg-gray-200">
                        {pdfFile ? (
                            ...
                            >
                                ...
                                <div className={isDrawing ? 'pointer-events-none select-none' : ''}>
