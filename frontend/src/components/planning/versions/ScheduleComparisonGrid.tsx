...
const ScheduleComparisonGrid: React.FC = () => {
    ...
    const columnDefs = useMemo(() => [
        { headerName: 'Activity Name', field: 'activityName', width: 250, pinned: 'left' as const },
        {
        ...
        },
        {
            ...
            valueFormatter: (params: any) => `${params.value > 0 ? '+' : ''}${params.value} d`
        },
        {
    ...
    if (loading) {
        return <div className="p-8 text-center text-gray-500">Loading comparison analysis...</div>;
    }
    ...
    return (
        <div className="h-full flex flex-col p-6 max-w-7xl mx-auto">
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">Schedule Variance Analysis</h1>
                    <p className="text-gray-500 text-sm">Comparing Version {v1Id} vs {v2Id}</p>
                </div>
            </div>
