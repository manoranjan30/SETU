...
const EpsModal: React.FC<EpsModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
  mode,
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full border border-border-strong rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary"
          ...
          <div className="flex justify-end gap-2">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 text-text-secondary bg-surface-raised rounded hover:bg-gray-200"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={loading}
              className="px-4 py-2 text-white bg-primary rounded hover:bg-primary-dark disabled:opacity-50 flex items-center"
            >
