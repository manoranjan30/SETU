...
const WorkOrderManualEntryModal: React.FC<Props> = ({
  isOpen,
  onClose,
  onSuccess,
}) => {
  ...
  if (step === "vendor") {
    return (
      <Modal
        isOpen={isOpen}
        onClose={handleClose}
        title="Create Work Order — Step 1: Select Vendor"
      >
        <div className="space-y-6 py-4">
          <div className="flex gap-4">
            ...
            >
              <Building2
                className={`w-8 h-8 mx-auto mb-2 ${vendorMode === "existing" ? "text-primary" : "text-text-disabled"}`}
              />
              <p
                className={`font-bold ${vendorMode === "existing" ? "text-blue-700" : "text-text-secondary"}`}
              >
                Existing Vendor
              </p>
              <p className="text-xs text-text-muted">
                Select from registered vendors
              </p>
            </button>
            <button
              ...
              className={`flex-1 p-4 rounded-xl border-2 transition-all ${
                vendorMode === "new"
                  ? "border-success bg-success-muted shadow-lg"
                  : "border-border-default hover:border-border-strong"
              }`}
            >
              <UserPlus
                className={`w-8 h-8 mx-auto mb-2 ${vendorMode === "new" ? "text-success" : "text-text-disabled"}`}
              />
              <p
                className={`font-bold ${vendorMode === "new" ? "text-green-700" : "text-text-secondary"}`}
              >
                New Vendor
              </p>
              <p className="text-xs text-text-muted">
          ...
          {vendorMode === "existing" && (
            <div className="bg-surface-base p-4 rounded-xl border border-border-default">
              <div className="relative mb-3">
                <Search className="absolute left-3 top-3 text-text-disabled w-4 h-4" />
                <input
                  type="text"
                    ...
                    <div
                      ...
                      className={`p-3 rounded-lg cursor-pointer border transition-all ${
                        selectedVendor?.id === v.id
                          ? "bg-info-muted border-primary ring-1 ring-primary"
          ...
          {vendorMode === "new" && (
            <div className="text-center p-8 bg-success-muted rounded-xl border border-green-200">
              <UserPlus className="w-12 h-12 mx-auto text-success mb-4" />
              <p className="font-bold text-green-800 mb-2">Create New Vendor</p>
              <p className="text-sm text-success mb-4">
                Register the vendor before creating their Work Order.
              </p>
              <button
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-border-default">
            <button
              onClick={handleClose}
              className="px-4 py-2 text-text-muted hover:text-gray-800 font-medium"
            >
              Cancel
            </button>
            <button
              ...
              className="px-6 py-3 bg-primary text-white font-bold rounded-xl hover:bg-primary-dark disabled:bg-gray-300 disabled:cursor-not-allowed transition-all shadow-lg flex items-center gap-2"
            >
  ...
  if (step === "header") {
    return (
      <Modal
        isOpen={isOpen}
        onClose={handleClose}
        title="Create Work Order — Step 2: Order Details"
      >
        <div className="space-y-6 py-4 max-h-[80vh] overflow-auto">
          {/* Vendor badge */}
          <div className="bg-primary-muted border border-blue-200 rounded-xl p-3 flex gap-3 items-center">
          ...
          <div className="space-y-4">
            <h4 className="text-xs font-black text-text-muted uppercase tracking-wider flex items-center gap-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-xs font-bold text-slate-600 mb-1">
                  Work Order Date <span className="text-error">*</span>
                </label>
                <input
                  type="date"
                  className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-primary bg-surface-card"
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateHeader("orderAmendDate", e.target.value)
                  }
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateHeader("orderValidityStart", e.target.value)
                  }
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateHeader("orderValidityEnd", e.target.value)
                  }
                />
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateHeader("projectDescription", e.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-primary resize-none"
          ...
          <div className="flex justify-between gap-3 pt-4 border-t border-border-default">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-text-muted hover:text-gray-800 font-medium"
            >
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={handleClose}
      title="Create Work Order — Step 3: Line Items"
    >
      <div className="space-y-5 max-h-[85vh] flex flex-col">
        {/* Summary bar */}
        <div className="bg-surface-base p-3 rounded-xl border border-border-default flex justify-between items-center shrink-0">
          <div className="flex gap-6">
            <div>
              <span className="text-[10px] font-black text-text-disabled uppercase">
                Order
              </span>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              {items.map((item, idx) => (
                <tr
                  key={item.id}
                  className="hover:bg-primary-muted/30 transition-colors group"
                >
                  <td className="px-2 py-2 text-center text-text-disabled font-mono text-xs">
                    {idx + 1}
                  </td>
                  <td className="px-2 py-2">
                    <input
                      type="text"
                      placeholder="Code"
                      className="w-full bg-transparent px-1 py-1 border-b border-transparent hover:border-slate-300 focus:border-primary focus:outline-none text-text-secondary"
                      value={item.code}
                  ...
                  <td className="px-2 py-2">
                    <input
                      ...
                      className="w-full bg-transparent px-1 py-1 border-b border-transparent hover:border-slate-300 focus:border-primary focus:outline-none"
                  ...
                  <td className="px-2 py-2">
                    <select
                      className="w-full bg-transparent px-1 py-1 border-b border-transparent hover:border-slate-300 focus:border-primary focus:outline-none text-sm"
                      value={item.uom}
                  ...
                  <td className="px-2 py-2">
                    <input
                      ...
                      step="0.001"
                      min="0"
                      className="w-full text-right bg-transparent px-1 py-1 border-b border-transparent hover:border-slate-300 focus:border-primary focus:outline-none"
                      value={item.qty || ""}
                      onChange={(e) =>
                  ...
                  <td className="px-2 py-2 text-center">
                    <button
                      ...
                      className="p-1 text-slate-300 hover:text-error hover:bg-error-muted rounded transition-all disabled:opacity-30 disabled:hover:text-slate-300 disabled:hover:bg-transparent opacity-0 group-hover:opacity-100"
                      title="Remove"
                    >
        ...
        <div className="flex gap-4 shrink-0 mt-4">
          <button
            onClick={addItem}
            className="flex-1 py-2 border-2 border-dashed border-slate-300 rounded-xl text-text-muted hover:border-blue-400 hover:text-primary hover:bg-primary-muted/50 transition-all flex items-center justify-center gap-2 font-bold text-sm"
          >
        ...
        {/* Footer */}
        <div className="flex justify-between gap-3 pt-4 border-t border-border-default shrink-0">
          <button
            onClick={() => setStep("header")}
            className="flex items-center gap-2 px-4 py-2 text-text-muted hover:text-gray-800 font-medium"
          >
          ...
          <div className="flex gap-3">
            <button
              onClick={handleClose}
              className="px-4 py-2 text-error hover:text-red-700 font-medium"
            >
              Cancel
            </button>
            <button
