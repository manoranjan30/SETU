...
export declare class SeedService implements OnApplicationBootstrap {
    ...
    constructor(permissionRepo: Repository<Permission>, roleRepo: Repository<Role>, userRepo: Repository<User>, categoryRepo: Repository<DrawingCategory>, templateRepo: Repository<WorkDocTemplate>);
