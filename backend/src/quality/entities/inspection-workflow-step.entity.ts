...
export class InspectionWorkflowStep {
    ...
    @ManyToOne(() => InspectionWorkflowRun, run => run.steps, { onDelete: 'CASCADE' })
    ...
    @ManyToOne(() => ApprovalWorkflowNode, { onDelete: 'SET NULL', nullable: true })
    ...
    @Column({ type: 'enum', enum: WorkflowStepStatus, default: WorkflowStepStatus.WAITING })
