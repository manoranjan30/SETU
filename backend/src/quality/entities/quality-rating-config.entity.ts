...
export class QualityRatingConfig {
    ...
    @Column('jsonb', {
        default: [
            { status: 'Structure', observations: 5, documentation: 5, customerInspections: 0 },
            { status: 'Structure + Finishes', observations: 5, documentation: 5, customerInspections: 0 },
            { status: 'Finishes', observations: 5, documentation: 5, customerInspections: 0 },
            { status: 'Finishes + Customer Inspections', observations: 4, documentation: 2, customerInspections: 4 }
        ]
    })
    categoryWeights: any[];
