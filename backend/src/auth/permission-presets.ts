...
const PROGRESS_VIEWER: PermissionPreset = {
    ...
    description: 'Read-only view of site progress, schedules, and project data. Cannot enter or change anything.',
...
const PROGRESS_ENTRY_OPERATOR: PermissionPreset = {
    ...
    description: 'Can view the activity list and submit daily site progress entries and micro-schedule logs.',
    group: 'Project Execution',
    tier: 2,
    icon: 'ClipboardCheck',
    permissions: [
...
const PROGRESS_APPROVER: PermissionPreset = {
    ...
    description: 'Can approve or reject site progress submissions. Includes all entry operator permissions.',
    group: 'Project Execution',
    tier: 3,
    icon: 'BadgeCheck',
    permissions: [
...
const SCHEDULE_VIEWER: PermissionPreset = {
    ...
    description: 'Read-only access to Gantt charts, baselines, calendars, and distribution matrix.',
...
const SCHEDULE_PLANNER: PermissionPreset = {
    ...
    description: 'Can build and update WBS structures, import schedules, create micro-schedules, and create look-ahead plans.',
    group: 'Planning & Scheduling',
    tier: 2,
    icon: 'GanttChart',
    permissions: [
...
const SCHEDULE_ADMIN: PermissionPreset = {
    id: 'SCHEDULE_ADMIN',
    name: 'Schedule Admin',
    description: 'Full schedule control — can delete WBS nodes, manage template library, create recovery plans, and activate micro-schedules.',
    group: 'Planning & Scheduling',
    tier: 3,
    icon: 'Settings2',
    permissions: [
...
const BOQ_VIEWER: PermissionPreset = {
    id: 'BOQ_VIEWER',
    name: 'BOQ Viewer',
    description: 'Read-only access to Bill of Quantities, work orders, and cost data.',
    group: 'BOQ & Cost',
    tier: 1,
...
const BOQ_CONTRIBUTOR: PermissionPreset = {
    ...
    description: 'Can create and update BOQ items, manage measurements, import data, and link work orders.',
    group: 'BOQ & Cost',
    tier: 2,
    icon: 'ClipboardList',
    permissions: [
...
const BOQ_ADMIN: PermissionPreset = {
    id: 'BOQ_ADMIN',
    name: 'BOQ Admin',
    description: 'Full BOQ control — can delete items, bulk import, and manage vendor work order templates.',
    group: 'BOQ & Cost',
    tier: 3,
    icon: 'Database',
    permissions: [
...
const QUALITY_VIEWER: PermissionPreset = {
    id: 'QUALITY_VIEWER',
    name: 'Quality Viewer',
    description: 'Read-only view of QC records, checklists, inspection status, NCRs, and snags.',
    group: 'Quality (QA/QC)',
    tier: 1,
    icon: 'ClipboardCheck',
    permissions: [
...
const QC_FIELD_INSPECTOR: PermissionPreset = {
    ...
    description: 'Can raise RFIs, log NCRs and snags, perform material tests. Ideal for QC engineers on site.',
    group: 'Quality (QA/QC)',
    tier: 2,
    icon: 'Search',
    permissions: [
...
const QC_MANAGER: PermissionPreset = {
    id: 'QC_MANAGER',
    name: 'QC Manager',
    description: 'Full QC control — manages checklists, activity lists, sequence graphs, approves inspections.',
    group: 'Quality (QA/QC)',
    tier: 3,
    icon: 'ShieldCheck',
    permissions: [
...
const EHS_VIEWER: PermissionPreset = {
    id: 'EHS_VIEWER',
    name: 'EHS Viewer',
    description: 'Read-only view of all safety records, incidents, inspections, trainings, and manhour data.',
    group: 'Safety (EHS)',
    tier: 1,
    icon: 'ShieldAlert',
    permissions: [
...
const EHS_FIELD_OFFICER: PermissionPreset = {
    ...
    description: 'Can log safety observations, incidents, manhours, training records, and environmental data on site.',
    group: 'Safety (EHS)',
    tier: 2,
    icon: 'HardHat',
    permissions: [
...
const EHS_MANAGER: PermissionPreset = {
    id: 'EHS_MANAGER',
    name: 'EHS Manager',
    description: 'Full EHS control — manages all records, legal compliance, machinery, vehicles, and incident register.',
    group: 'Safety (EHS)',
    tier: 3,
    icon: 'ShieldCheck',
    permissions: [
...
const DRAWINGS_CONTRIBUTOR: PermissionPreset = {
    ...
    description: 'Can register new drawings, upload revisions, and update drawing metadata.',
    group: 'Design & Drawings',
    tier: 2,
    icon: 'Upload',
    permissions: [
...
const DRAWINGS_ADMIN: PermissionPreset = {
    id: 'DRAWINGS_ADMIN',
    name: 'Drawings Admin',
    description: 'Full drawings control — can approve GFC drawings and delete entries.',
    group: 'Design & Drawings',
    tier: 3,
    icon: 'Stamp',
    permissions: [
...
const LABOR_ENTRY_OPERATOR: PermissionPreset = {
    ...
    description: 'Can log daily attendance headcount and link labor to activities.',
...
const LABOR_ADMIN: PermissionPreset = {
    id: 'LABOR_ADMIN',
    name: 'Labor Admin',
    description: 'Full labor management — creates labor categories and can import bulk manpower data.',
    group: 'Labor Management',
    tier: 3,
    icon: 'UserCog',
    permissions: [
...
const USER_ADMIN: PermissionPreset = {
    ...
    description: 'Can create and manage users, assign roles, and view system audit logs.',
...
const RESOURCE_ADMIN: PermissionPreset = {
    ...
    description: 'Can manage resource master data, templates, and checklist builder.',
    group: 'Administration',
    tier: 3,
    icon: 'Package',
    permissions: [
...
export const COMPOSITE_ROLE_TEMPLATES: CompositeRoleTemplate[] = [
    {
        id: 'SITE_ENGINEER',
        name: 'Site Engineer',
        description: 'Field team: enters daily progress, logs manpower, raises safety and QC items. Access to all read views.',
        icon: 'HardHat',
        presetIds: [
            'PROGRESS_ENTRY_OPERATOR',
            'LABOR_ENTRY_OPERATOR',
    ...
    },
    {
        ...
        description: 'Builds and maintains schedules, distributes BOQ, creates micro-schedules and look-ahead plans.',
        icon: 'GanttChart',
        presetIds: [
            'SCHEDULE_PLANNER',
            'BOQ_VIEWER',
    ...
    },
    {
        ...
        description: 'Reviews all data, approves progress, oversees quality, safety, drawings, and labor.',
        icon: 'Briefcase',
        presetIds: [
            'PROGRESS_APPROVER',
            'SCHEDULE_PLANNER',
    ...
    },
    {
        ...
        description: 'Manages BOQ items, measurements, subcontractor work orders, and cost tracking.',
        icon: 'Calculator',
        presetIds: [
            'BOQ_ADMIN',
            'SCHEDULE_VIEWER',
    ...
    },
    {
        id: 'QC_ENGINEER',
        name: 'QA/QC Engineer',
        description: 'Manages quality checklists, activity lists, raises and approves RFIs, logs material tests.',
        icon: 'Microscope',
        presetIds: [
            'QC_MANAGER',
            'DRAWINGS_VIEWER',
    ...
    },
    {
        id: 'SAFETY_OFFICER',
        name: 'Safety Officer',
        description: 'Full EHS management — logs all safety observations, incidents, manhours, and legal compliance.',
        icon: 'ShieldAlert',
        presetIds: [
            'EHS_MANAGER',
            'LABOR_ENTRY_OPERATOR',
    ...
    },
    {
        ...
        description: 'Read-only access across all modules. Cannot enter or change any data.',
        icon: 'Eye',
        presetIds: [
            'PROGRESS_VIEWER',
            'BOQ_VIEWER',
    ...
    },
    {
        ...
        description: 'Full system administration — manages users, roles, resources, and templates. Has all permissions.',
        icon: 'Terminal',
        presetIds: [
            'USER_ADMIN',
            'RESOURCE_ADMIN',
