...
const SCHEDULE_VIEWER: PermissionPreset = {
  ...
  permissions: [
    ...
    'PLANNING.MATRIX.READ',
    'PLANNING.ANALYSIS.READ',
    'PLANNING.HEALTH.READ',
    'PLANNING.TASK.READ',
    'PLANNING.FOLLOWUP.READ',
    'PLANNING.JOURNAL.READ',
    'PLANNING.CUSTOM_TRACKER.READ',
    'PROGRESS.DASHBOARD.READ',
    'DASHBOARD.SUMMARY.READ',
...
const SCHEDULE_PLANNER: PermissionPreset = {
  ...
  permissions: [
    ...
    'PLANNING.HEALTH.CREATE',
    'PLANNING.HEALTH.UPDATE',
    'PLANNING.HEALTH.SUBMIT',
    'PLANNING.HEALTH.IMPORT',
    'PLANNING.HEALTH.EXPORT',
    ...
    'PLANNING.CUSTOM_TRACKER.CREATE',
    'PLANNING.CUSTOM_TRACKER.UPDATE',
...
const SCHEDULE_ADMIN: PermissionPreset = {
  ...
  permissions: [
    ...
    'SCHEDULE.VERSION.DELETE',
    'MICRO.SCHEDULE.DELETE',
    'MICRO.SCHEDULE.MANAGE',
    'MICRO.ACTIVITY.DELETE',
    'PLANNING.RECOVERY.MANAGE',
    'PLANNING.HEALTH.LOCK',
    'PLANNING.HEALTH.REOPEN',
    'PLANNING.HEALTH.DELETE',
    'PLANNING.HEALTH.CONFIG',
    'PLANNING.TASK.DELETE',
    'PLANNING.FOLLOWUP.DELETE',
    'PLANNING.JOURNAL.DELETE',
    'PLANNING.CUSTOM_TRACKER.DELETE',
    'PLANNING.CUSTOM_TRACKER.CONFIG',
    'DASHBOARD.EXECUTIVE.READ',
  ],
};
...
const QUALITY_VIEWER: PermissionPreset = {
  ...
  permissions: [
    ...
    'QUALITY.STRUCTURE.READ',
    'QUALITY.WORKFLOW.READ',
    'QUALITY.RATING.READ',
    'QUALITY.NCR.READ',
    'QUALITY.SNAG.READ',
    'QUALITY.TEST.READ',
    ...
    'QUALITY.MATERIAL_TEST.READ',
    'QUALITY.CUBE_TEST.READ',
...
const QC_FIELD_INSPECTOR: PermissionPreset = {
  ...
  description:
    'Can raise and update RFIs, prepare and sign pour documents, log material tests, and rectify observations without approval or delete powers.',
  group: 'Quality (QA/QC)',
  tier: 2,
  icon: 'Search',
  permissions: [
    ...
    'QUALITY.CUBE_TEST.CREATE',
    'QUALITY.CUBE_TEST.UPDATE',
    'QUALITY.CUBE_TEST.SAVE',
...
const QC_MANAGER: PermissionPreset = {
  ...
  icon: 'ShieldCheck',
  permissions: [
    ...QUALITY_PERMISSIONS.map((permission) => permission.code),
  ],
};
