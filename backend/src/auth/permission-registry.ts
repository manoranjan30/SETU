...
export const SCHEDULE_PERMISSIONS: PermissionDef[] = [
  ...
  perm('SCHEDULE.VERSION.UPDATE', 'Update Baseline Versions', 'SCHEDULE', U),
  perm('SCHEDULE.VERSION.DELETE', 'Delete Baseline Versions', 'SCHEDULE', D),
...
export const PLANNING_PERMISSIONS: PermissionDef[] = [
  ...
  perm('PLANNING.HEALTH.READ', 'View Project Health Reports', 'PLANNING', R),
  perm('PLANNING.HEALTH.CREATE', 'Create Project Health Reports', 'PLANNING', C),
  perm('PLANNING.HEALTH.UPDATE', 'Update Project Health Reports', 'PLANNING', U),
  perm('PLANNING.HEALTH.SUBMIT', 'Submit Project Health Reports', 'PLANNING', S),
  perm('PLANNING.HEALTH.LOCK', 'Lock Project Health Reports', 'PLANNING', S),
  perm('PLANNING.HEALTH.REOPEN', 'Reopen Project Health Reports', 'PLANNING', S),
  perm('PLANNING.HEALTH.DELETE', 'Delete Project Health Reports', 'PLANNING', D),
  perm('PLANNING.HEALTH.EXPORT', 'Export Project Health Reports', 'PLANNING', S),
  perm('PLANNING.HEALTH.CONFIG', 'Configure Project Health Scoring', 'PLANNING', S),
  perm('PLANNING.HEALTH.IMPORT', 'Import Project Health Reports', 'PLANNING', C),
  perm('PLANNING.TASK.READ', 'View Planning Tasks', 'PLANNING', R),
  perm('PLANNING.TASK.CREATE', 'Create Planning Tasks', 'PLANNING', C),
  perm('PLANNING.TASK.UPDATE', 'Update Planning Tasks', 'PLANNING', U),
  perm('PLANNING.TASK.DELETE', 'Delete Planning Tasks', 'PLANNING', D),
  perm('PLANNING.FOLLOWUP.READ', 'View Follow-up Register', 'PLANNING', R),
  perm('PLANNING.FOLLOWUP.CREATE', 'Create Follow-up Actions', 'PLANNING', C),
  perm('PLANNING.FOLLOWUP.UPDATE', 'Update Follow-up Actions', 'PLANNING', U),
  perm('PLANNING.FOLLOWUP.DELETE', 'Delete Follow-up Actions', 'PLANNING', D),
  perm('PLANNING.JOURNAL.READ', 'View Site Journal', 'PLANNING', R),
...
export const QUALITY_PERMISSIONS: PermissionDef[] = [
  ...
  perm('QUALITY.SNAG_CONFIG.READ', 'Read Snag Configuration', 'QUALITY', S),
  perm('QUALITY.SNAG_CONFIG.MANAGE', 'Manage Snag Configuration', 'QUALITY', S),
  perm(
    'QUALITY.BATCH_SLIP_CONFIG.READ',
    'Read Pour Card Batch Slip Scan Configuration',
    'QUALITY',
    R,
  ),
  perm(
    'QUALITY.BATCH_SLIP_CONFIG.MANAGE',
    'Manage Pour Card Batch Slip Scan Configuration',
    'QUALITY',
    S,
  ),
