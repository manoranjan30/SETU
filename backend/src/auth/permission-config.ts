...
export const PERMISSION_DEPENDENCIES: Record<string, string[]> = {
  ...
  [PermissionCode.DESIGN_UPLOAD]: [
    PermissionCode.DESIGN_READ,
    PermissionCode.VIEW_PROJECTS,
  ],
  [PermissionCode.DESIGN_APPROVE]: [
    PermissionCode.DESIGN_READ,
    PermissionCode.VIEW_PROJECTS,
  ],
  ...
  [PermissionCode.PLANNING_EDIT]: [
    PermissionCode.PLANNING_READ,
    PermissionCode.VIEW_PROJECTS,
  ],
  [PermissionCode.PLANNING_BASELINE]: [
    PermissionCode.PLANNING_READ,
    PermissionCode.VIEW_PROJECTS,
  ],
  ...
  [PermissionCode.BOQ_MANAGE]: [
    PermissionCode.BOQ_READ,
    PermissionCode.VIEW_PROJECTS,
  ],

  // Execution
  [PermissionCode.EXECUTION_READ]: [PermissionCode.VIEW_PROJECTS],
  [PermissionCode.EXECUTION_UPDATE]: [
  ...
  [PermissionCode.EHS_MANAGE]: [
    PermissionCode.EHS_READ,
    PermissionCode.VIEW_PROJECTS,
  ],

  // Labor
  [PermissionCode.LABOR_READ]: [PermissionCode.VIEW_PROJECTS],
  [PermissionCode.LABOR_MANAGE]: [
    PermissionCode.LABOR_READ,
    PermissionCode.VIEW_PROJECTS,
  ],
};
